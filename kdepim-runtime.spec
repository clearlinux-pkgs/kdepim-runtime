...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kdepim-runtime-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kdepim-runtime-24.12.1.tar.xz.sig
...
%setup -q -n kdepim-runtime-24.12.1
cd %{_builddir}/kdepim-runtime-24.12.1
pushd ..
cp -a kdepim-runtime-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736781392
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.6.3.1
/V3/usr/lib64/libakonadi-singlefileresource.so.6.3.1
/V3/usr/lib64/libfolderarchivesettings.so.6.3.1
/V3/usr/lib64/libkmindexreader.so.6.3.1
/V3/usr/lib64/libmaildir.so.6.3.1
/V3/usr/lib64/libnewmailnotifier.so.6.3.1
...
/usr/lib64/libakonadi-filestore.so.6.3.1
/usr/lib64/libakonadi-singlefileresource.so.6
/usr/lib64/libakonadi-singlefileresource.so.6.3.1
/usr/lib64/libfolderarchivesettings.so.6
/usr/lib64/libfolderarchivesettings.so.6.3.1
/usr/lib64/libkmindexreader.so.6
/usr/lib64/libkmindexreader.so.6.3.1
/usr/lib64/libmaildir.so.6
/usr/lib64/libmaildir.so.6.3.1
/usr/lib64/libnewmailnotifier.so.6
/usr/lib64/libnewmailnotifier.so.6.3.1
