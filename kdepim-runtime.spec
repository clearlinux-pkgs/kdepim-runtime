...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712940330
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.6.0.2
/V3/usr/lib64/libakonadi-singlefileresource.so.6.0.2
/V3/usr/lib64/libfolderarchivesettings.so.6.0.2
/V3/usr/lib64/libkmindexreader.so.6.0.2
/V3/usr/lib64/libmaildir.so.6.0.2
/V3/usr/lib64/libnewmailnotifier.so.6.0.2
...
/usr/lib64/libakonadi-filestore.so.6.0.2
/usr/lib64/libakonadi-singlefileresource.so.6
/usr/lib64/libakonadi-singlefileresource.so.6.0.2
/usr/lib64/libfolderarchivesettings.so.6
/usr/lib64/libfolderarchivesettings.so.6.0.2
/usr/lib64/libkmindexreader.so.6
/usr/lib64/libkmindexreader.so.6.0.2
/usr/lib64/libmaildir.so.6
/usr/lib64/libmaildir.so.6.0.2
/usr/lib64/libnewmailnotifier.so.6
/usr/lib64/libnewmailnotifier.so.6.0.2
