...
Version  : 24.05.2
Release  : 86
URL      : https://download.kde.org/stable/release-service/24.05.2/src/kdepim-runtime-24.05.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kdepim-runtime-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kdepim-runtime-24.05.2.tar.xz.sig
...
%setup -q -n kdepim-runtime-24.05.2
cd %{_builddir}/kdepim-runtime-24.05.2
pushd ..
cp -a kdepim-runtime-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720638173
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.6.1.2
/V3/usr/lib64/libakonadi-singlefileresource.so.6.1.2
/V3/usr/lib64/libfolderarchivesettings.so.6.1.2
/V3/usr/lib64/libkmindexreader.so.6.1.2
/V3/usr/lib64/libmaildir.so.6.1.2
/V3/usr/lib64/libnewmailnotifier.so.6.1.2
...
/V3/usr/lib64/qt6/plugins/pim6/akonadi/config/tomboynotesconfig.so
...
/usr/lib64/libakonadi-filestore.so.6.1.2
/usr/lib64/libakonadi-singlefileresource.so.6
/usr/lib64/libakonadi-singlefileresource.so.6.1.2
/usr/lib64/libfolderarchivesettings.so.6
/usr/lib64/libfolderarchivesettings.so.6.1.2
/usr/lib64/libkmindexreader.so.6
/usr/lib64/libkmindexreader.so.6.1.2
/usr/lib64/libmaildir.so.6
/usr/lib64/libmaildir.so.6.1.2
/usr/lib64/libnewmailnotifier.so.6
/usr/lib64/libnewmailnotifier.so.6.1.2
...
/usr/lib64/qt6/plugins/pim6/akonadi/config/tomboynotesconfig.so
