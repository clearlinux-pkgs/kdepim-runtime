...
Version  : 24.05.1
Release  : 83
URL      : https://download.kde.org/stable/release-service/24.05.1/src/kdepim-runtime-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kdepim-runtime-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kdepim-runtime-24.05.1.tar.xz.sig
...
%setup -q -n kdepim-runtime-24.05.1
cd %{_builddir}/kdepim-runtime-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718638687
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.6.1.1
/V3/usr/lib64/libakonadi-singlefileresource.so.6.1.1
/V3/usr/lib64/libfolderarchivesettings.so.6.1.1
/V3/usr/lib64/libkmindexreader.so.6.1.1
/V3/usr/lib64/libmaildir.so.6.1.1
/V3/usr/lib64/libnewmailnotifier.so.6.1.1
...
/usr/lib64/libakonadi-filestore.so.6.1.1
/usr/lib64/libakonadi-singlefileresource.so.6
/usr/lib64/libakonadi-singlefileresource.so.6.1.1
/usr/lib64/libfolderarchivesettings.so.6
/usr/lib64/libfolderarchivesettings.so.6.1.1
/usr/lib64/libkmindexreader.so.6
/usr/lib64/libkmindexreader.so.6.1.1
/usr/lib64/libmaildir.so.6
/usr/lib64/libmaildir.so.6.1.1
/usr/lib64/libnewmailnotifier.so.6
/usr/lib64/libnewmailnotifier.so.6.1.1
