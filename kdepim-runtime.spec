...
Version  : 24.02.0
Release  : 72
URL      : https://download.kde.org/stable/release-service/24.02.0/src/kdepim-runtime-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kdepim-runtime-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kdepim-runtime-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kdepim-runtime-24.02.0
cd %{_builddir}/kdepim-runtime-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710441665
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.6.0.0
/V3/usr/lib64/libakonadi-singlefileresource.so.6.0.0
/V3/usr/lib64/libfolderarchivesettings.so.6.0.0
/V3/usr/lib64/libkmindexreader.so.6.0.0
/V3/usr/lib64/libmaildir.so.6.0.0
/V3/usr/lib64/libnewmailnotifier.so.6.0.0
...
/usr/lib64/libakonadi-filestore.so.6.0.0
/usr/lib64/libakonadi-singlefileresource.so.6
/usr/lib64/libakonadi-singlefileresource.so.6.0.0
/usr/lib64/libfolderarchivesettings.so.6
/usr/lib64/libfolderarchivesettings.so.6.0.0
/usr/lib64/libkmindexreader.so.6
/usr/lib64/libkmindexreader.so.6.0.0
/usr/lib64/libmaildir.so.6
/usr/lib64/libmaildir.so.6.0.0
/usr/lib64/libnewmailnotifier.so.6
/usr/lib64/libnewmailnotifier.so.6.0.0
