...
Version  : 24.12.3
Release  : 106
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kdepim-runtime-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kdepim-runtime-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kdepim-runtime-24.12.3.tar.xz.sig
...
%setup -q -n kdepim-runtime-24.12.3
cd %{_builddir}/kdepim-runtime-24.12.3
pushd ..
cp -a kdepim-runtime-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742572687
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.6.3.3
/V3/usr/lib64/libakonadi-singlefileresource.so.6.3.3
/V3/usr/lib64/libfolderarchivesettings.so.6.3.3
/V3/usr/lib64/libkmindexreader.so.6.3.3
/V3/usr/lib64/libmaildir.so.6.3.3
/V3/usr/lib64/libnewmailnotifier.so.6.3.3
...
/usr/lib64/libakonadi-filestore.so.6.3.3
/usr/lib64/libakonadi-singlefileresource.so.6
/usr/lib64/libakonadi-singlefileresource.so.6.3.3
/usr/lib64/libfolderarchivesettings.so.6
/usr/lib64/libfolderarchivesettings.so.6.3.3
/usr/lib64/libkmindexreader.so.6
/usr/lib64/libkmindexreader.so.6.3.3
/usr/lib64/libmaildir.so.6
/usr/lib64/libmaildir.so.6.3.3
/usr/lib64/libnewmailnotifier.so.6
/usr/lib64/libnewmailnotifier.so.6.3.3
