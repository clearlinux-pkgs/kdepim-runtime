...
Version  : 22.12.1
Release  : 42
URL      : https://download.kde.org/stable/release-service/22.12.1/src/kdepim-runtime-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kdepim-runtime-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kdepim-runtime-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kdepim-runtime-22.12.1
cd %{_builddir}/kdepim-runtime-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673387929
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakonadi-filestore.so.5.22.1
/usr/lib64/libakonadi-singlefileresource.so.5
/usr/lib64/libakonadi-singlefileresource.so.5.22.1
/usr/lib64/libfolderarchivesettings.so.5
/usr/lib64/libfolderarchivesettings.so.5.22.1
/usr/lib64/libkmindexreader.so.5
/usr/lib64/libkmindexreader.so.5.22.1
/usr/lib64/libmaildir.so.5
/usr/lib64/libmaildir.so.5.22.1
