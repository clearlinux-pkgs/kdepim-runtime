...
Version  : 23.08.5
Release  : 71
URL      : https://download.kde.org/stable/release-service/23.08.5/src/kdepim-runtime-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/kdepim-runtime-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/kdepim-runtime-23.08.5.tar.xz.sig
...
%prep
%setup -q -n kdepim-runtime-23.08.5
cd %{_builddir}/kdepim-runtime-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708448030
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.5.24.5
/V3/usr/lib64/libakonadi-singlefileresource.so.5.24.5
/V3/usr/lib64/libfolderarchivesettings.so.5.24.5
/V3/usr/lib64/libkmindexreader.so.5.24.5
/V3/usr/lib64/libmaildir.so.5.24.5
...
/usr/lib64/libakonadi-filestore.so.5.24.5
/usr/lib64/libakonadi-singlefileresource.so.5
/usr/lib64/libakonadi-singlefileresource.so.5.24.5
/usr/lib64/libfolderarchivesettings.so.5
/usr/lib64/libfolderarchivesettings.so.5.24.5
/usr/lib64/libkmindexreader.so.5
/usr/lib64/libkmindexreader.so.5.24.5
/usr/lib64/libmaildir.so.5
/usr/lib64/libmaildir.so.5.24.5
