...
%prep
%setup -q -n kdepim-runtime-24.02.1
cd %{_builddir}/kdepim-runtime-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711208651
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.6.0.1
/V3/usr/lib64/libakonadi-singlefileresource.so.6.0.1
/V3/usr/lib64/libfolderarchivesettings.so.6.0.1
/V3/usr/lib64/libkmindexreader.so.6.0.1
/V3/usr/lib64/libmaildir.so.6.0.1
/V3/usr/lib64/libnewmailnotifier.so.6.0.1
...
/usr/lib64/libakonadi-filestore.so.6.0.1
/usr/lib64/libakonadi-singlefileresource.so.6
/usr/lib64/libakonadi-singlefileresource.so.6.0.1
/usr/lib64/libfolderarchivesettings.so.6
/usr/lib64/libfolderarchivesettings.so.6.0.1
/usr/lib64/libkmindexreader.so.6
/usr/lib64/libkmindexreader.so.6.0.1
/usr/lib64/libmaildir.so.6
/usr/lib64/libmaildir.so.6.0.1
/usr/lib64/libnewmailnotifier.so.6
/usr/lib64/libnewmailnotifier.so.6.0.1
