...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kdepim-runtime-22.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.0/src/kdepim-runtime-22.08.0.tar.xz.sig
...
%prep
%setup -q -n kdepim-runtime-22.08.0
cd %{_builddir}/kdepim-runtime-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661785644
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libakonadi-filestore.so.5.21.0
/usr/lib64/libakonadi-singlefileresource.so.5
/usr/lib64/libakonadi-singlefileresource.so.5.21.0
/usr/lib64/libfolderarchivesettings.so.5
/usr/lib64/libfolderarchivesettings.so.5.21.0
/usr/lib64/libkmindexreader.so.5
/usr/lib64/libkmindexreader.so.5.21.0
/usr/lib64/libmaildir.so.5
/usr/lib64/libmaildir.so.5.21.0
