...
Version  : 21.08.2
Release  : 25
URL      : https://download.kde.org/stable/release-service/21.08.2/src/kdepim-runtime-21.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/kdepim-runtime-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/kdepim-runtime-21.08.2.tar.xz.sig
...
%prep
%setup -q -n kdepim-runtime-21.08.2
cd %{_builddir}/kdepim-runtime-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634444718
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdepim-runtime-21.08.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kdepim-runtime/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/AGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/971f2a85c02441da0d59ff0790511592a0114532
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kdepim-runtime-21.08.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdepim-runtime/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
/usr/lib64/libakonadi-filestore.so.5.18.2
/usr/lib64/libakonadi-singlefileresource.so.5
/usr/lib64/libakonadi-singlefileresource.so.5.18.2
/usr/lib64/libfolderarchivesettings.so.5
/usr/lib64/libfolderarchivesettings.so.5.18.2
/usr/lib64/libkmindexreader.so.5
/usr/lib64/libkmindexreader.so.5.18.2
/usr/lib64/libmaildir.so.5
/usr/lib64/libmaildir.so.5.18.2
