...
%prep
%setup -q -n kdepim-runtime-23.08.2
cd %{_builddir}/kdepim-runtime-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697469177
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.5.24.2
/V3/usr/lib64/libakonadi-singlefileresource.so.5.24.2
/V3/usr/lib64/libfolderarchivesettings.so.5.24.2
/V3/usr/lib64/libkmindexreader.so.5.24.2
/V3/usr/lib64/libmaildir.so.5.24.2
...
/usr/lib64/libakonadi-filestore.so.5.24.2
/usr/lib64/libakonadi-singlefileresource.so.5
/usr/lib64/libakonadi-singlefileresource.so.5.24.2
/usr/lib64/libfolderarchivesettings.so.5
/usr/lib64/libfolderarchivesettings.so.5.24.2
/usr/lib64/libkmindexreader.so.5
/usr/lib64/libkmindexreader.so.5.24.2
/usr/lib64/libmaildir.so.5
/usr/lib64/libmaildir.so.5.24.2
