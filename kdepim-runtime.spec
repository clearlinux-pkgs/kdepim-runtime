...
Version  : 24.08.0
Release  : 89
URL      : https://download.kde.org/stable/release-service/24.08.0/src/kdepim-runtime-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kdepim-runtime-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kdepim-runtime-24.08.0.tar.xz.sig
...
%setup -q -n kdepim-runtime-24.08.0
cd %{_builddir}/kdepim-runtime-24.08.0
pushd ..
cp -a kdepim-runtime-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724696776
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libakonadi-filestore.so.6.2.0
/V3/usr/lib64/libakonadi-singlefileresource.so.6.2.0
/V3/usr/lib64/libfolderarchivesettings.so.6.2.0
/V3/usr/lib64/libkmindexreader.so.6.2.0
/V3/usr/lib64/libmaildir.so.6.2.0
/V3/usr/lib64/libnewmailnotifier.so.6.2.0
...
/usr/lib64/libakonadi-filestore.so.6.2.0
/usr/lib64/libakonadi-singlefileresource.so.6
/usr/lib64/libakonadi-singlefileresource.so.6.2.0
/usr/lib64/libfolderarchivesettings.so.6
/usr/lib64/libfolderarchivesettings.so.6.2.0
/usr/lib64/libkmindexreader.so.6
/usr/lib64/libkmindexreader.so.6.2.0
/usr/lib64/libmaildir.so.6
/usr/lib64/libmaildir.so.6.2.0
/usr/lib64/libnewmailnotifier.so.6
/usr/lib64/libnewmailnotifier.so.6.2.0
